...
LOAD DATA INFILE '/nfs/elsrv4/users4/grad/rcgordon/cs445/project/cs445-project/data/rel_data/professional_formatted.txt' INTO TABLE Professionals FIELDS TERMINATED BY '\t';
